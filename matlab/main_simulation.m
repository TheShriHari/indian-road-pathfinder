%% SIH26037 - Adaptive Path Planning & Collision Avoidance Main Simulation
% Master closed-loop simulation script for MathWorks Smart Vehicles PS 26037.
% Features:
%   - Dark theme matching pitch deck visuals
%   - Live HUD showing: Replanning Latency, Path Smoothness, Scenario Completion
%   - Danger radius circle drawn around dynamic obstacles
%   - Smooth vehicle motion & dynamic obstacle replanning
%   - Multiple static obstacles (roadside clutter)
%   - Saves an animated GIF "sih26037_demo.gif" directly to your workspace
%
% Run this script in MATLAB Online (F5) or type: main_simulation
...
title(ax, 'Adaptive Path Planning & Collision Avoidance -- Village Road (PS 26037)', ...
...
fprintf('\n=======================================================\n');
fprintf('        SIH 2026 PS 26037 - MAIN SIMULATION SUMMARY     \n');
fprintf('=======================================================\n');
...
fprintf(' Animated GIF saved as    : %s\n', gifFile);
fprintf('=======================================================\n\n');
