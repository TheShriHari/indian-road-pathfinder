# Source: https://github.com/argoai/argoverse-api
...
- 
argoverse can be installed as a python package using  pip install -e /path_to_root_directory_of_the_repo/
...
- 
The track_labels_amodal folders contains object-oriented labels (in contrast to per-frame labels inper_sweep_annotations_amodal folders. Run following script to remaketrack_labels_amodal folders and fix existing issues:  python3 argoverse/utils/make_track_label_folders.py argoverse-tracking/train/
...
3D Tracking code can be found at [https://github.com/alliecc/argoverse_baselinetracker](https://github.com/alliecc/argoverse_baselinetracker) and Motion Forecasting code at [https://github.com/jagjeet-singh/argoverse-forecasting](https://github.com/jagjeet-singh/argoverse-forecasting)
Contributions are always welcome! Please be aware of our [contribution guidelines for this project](/argoverse/argoverse-api/blob/master/CONTRIBUTING.md).
...
We release our API under the MIT license. We retain the Apache 2.0 license on certain files. See [LICENSE](/argoverse/argoverse-api/blob/master/LICENSE)
- A nuScenes to Argoverse converter can be found at [https://github.com/bhavya01/nuscenes_to_argoverse](https://github.com/bhavya01/nuscenes_to_argoverse) , contributed by Bhavya Bahl and John Lambert.
- A Waymo Open Dataset to Argoverse converter can be found at [https://github.com/johnwlambert/waymo_to_argoverse](https://github.com/johnwlambert/waymo_to_argoverse) , contributed by John Lambert and Hemanth Chittanuru.